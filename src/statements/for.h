...
public:
    ...
    virtual bool CanOptimize(llvm::Module& mod, llvm::IRBuilder<>& builder, ASTFunction& func) override;
    virtual Optimization howToOptimize(llvm::Module& mod, llvm::IRBuilder<>& builder, ASTFunction& func) override;
};  